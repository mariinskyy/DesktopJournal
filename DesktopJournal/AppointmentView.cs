...
namespace DesktopJournal
{
    public partial class AppointmentView : UserControl
    {
        ...
        public void FillAppointment(string title, string description)
        {
            ...
            var titleHeight = TextRenderer.MeasureText(title, new Font("Bahnschrift", 13f), new Size(178, 30), 
                TextFormatFlags.WordBreak).Height;
            var descriptionHeight = TextRenderer.MeasureText(description, new Font("Bahnschrift", 10f), 
                new Size(178, 60), TextFormatFlags.WordBreak).Height;

            descriptionHeight = descriptionHeight > 100 ? descriptionHeight + 15 : descriptionHeight + 10;
            titleHeight = titleHeight > 20 ? titleHeight + 10 : titleHeight + 5;
            titleHeight = titleHeight > 100 ? titleHeight + 15 : titleHeight;
