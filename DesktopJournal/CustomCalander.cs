...
{
    public partial class CustomCalander : UserControl
    {
        ...
        private readonly Color PREVIOUS_MONTH_DAY_COLOR = Color.FromArgb(35, 34, 57, 62);
        public CustomCalander()
        {
            InitializeComponent();
        }
        ...
        public void DisplayDays(DateTime date)
        {
            ...
            {
                (tableLayoutPanel3.Controls[42 - i] as DayBlank).Refresh(PREVIOUS_MONTH_DAY_COLOR,
            ...
            for (int i = 0; i < days; i++)
            {
                ...
                {
                    (tableLayoutPanel3.Controls[42 - i - dayOfTheWeek] as DayBlank).Refresh(HOLIDAY_COLOR,
                        i + 1,
                ...
                {
                    (tableLayoutPanel3.Controls[42 - i - dayOfTheWeek] as DayBlank).Refresh(DAY_COLOR,
                        i + 1,
                        new DateTime(now.Year, now.Month, i + 1),
                        Color.Azure);
                }
            ...
            {
                (tableLayoutPanel3.Controls[i] as DayBlank).Refresh(PREVIOUS_MONTH_DAY_COLOR,
                    otherDays - i + 1,
